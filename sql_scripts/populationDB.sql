...
INSERT INTO Usuarios(ID, Nome, Sobrenome, Funcao, Login, Senha, URIFotoUsuario) VALUES(324, "Henrique", "Oliveira", "Admin", "Admin", "$2b$12$njgZecz1YL1dsQ5XBUQYEOfEbdavSKS8y3PRwTS8MHQq.7XqRQFcW", "URL_foto_usuario");

INSERT INTO Usuarios(ID, Nome, Sobrenome, Funcao, Login, Senha, URIFotoUsuario) VALUES(325, "Giovanna", "Ribeiro", "Usuario", "User", "$2b$12$b3qW15TkD9MacYINknrp6.0OkilcWqzbPKc/1QSXWGPzpYsil5Xo6", "URL_foto_usuario");

INSERT INTO Usuarios(ID, Nome, Sobrenome, Funcao, Login, Senha, URIFotoUsuario) VALUES(326, "Daniel", "Guimaraes", "Chefe", "Chefe", "$2b$12$UJmLBzKE9genv/yepPGHb.vfAllBQKFBzUEQlqMKmtSbwsJhqKVmK", "URL_foto_usuario");
